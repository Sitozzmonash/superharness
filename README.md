...
Development is complete through Phase 5 of the 14-phase roadmap. The repository includes the
async Agent/Thread/Turn runtime, provider-neutral model and tool layers, durable context and
SQLite Threads, external search/RAG/vision adapters, and cross-thread long-term memory. Credential-gated live provider
